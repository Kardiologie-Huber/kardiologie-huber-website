...
**Tut die Untersuchung weh?** – Nein. Es handelt sich um Gespräch und körperliche Untersuchung; weitere Tests werden nur bei Bedarf veranlasst.  
**Brauche ich eine Überweisung?** – **Wahlarztordination:** **keine Überweisung** nötig; direkte Terminvereinbarung möglich.  
**Werden sofort weitere Untersuchungen gemacht?** – Falls sinnvoll und zeitlich möglich ja, sonst planen wir einen Folgetermin.  
**Wie geht es danach weiter?** – Sie erhalten eine **klare Empfehlung** (z. B. Lebensstil, Medikation, Diagnostik) und – falls notwendig – einen **strukturierten Untersuchungsplan**.
