...
Die Polygraphie misst nachts Atemfluss, Atembewegungen, Sauerstoffsättigung und weitere Signale. So lassen sich Hinweise auf **Schlafapnoe** (Atemaussetzer) zuverlässig erfassen – in Ihrer gewohnten Schlafumgebung.
...
**Tut das weh?** – Nein; Gurte und Nasenbrille können kurz ungewohnt sein.  
**Schlafe ich damit schlechter?** – Häufig ja, etwas – die **Auswertung** berücksichtigt das.  
**Strahlenbelastung?** – Keine. Es werden nur Körperfunktionen aufgezeichnet.  
**Was ist der Unterschied zu Polysomnographie?** – Die **Polysomnographie** (Schlaflabor) erfasst zusätzlich Hirnaktivität/Schlafstadien. Sie wird eingesetzt, wenn die Polygraphie **nicht eindeutig** ist oder spezielle Fragestellungen bestehen.  
**Darf ich am nächsten Tag Auto fahren?** – Ja.

## Nach der Untersuchung

Wir erklären Ihnen die Ergebnisse (z. B. Ereignisrate, Sauerstoffverläufe) und besprechen **klare nächste Schritte** – z. B. Lagerungstherapie, **CPAP**-Anpassung, Unterkiefer-Protrusionsschiene, Gewichts- und Lebensstilmaßnahmen oder – falls nötig – **Überweisung ins Schlaflabor**.
